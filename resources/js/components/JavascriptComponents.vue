<template>
    <section class="section section-components">
        <div class="container">
            ...
            <div class="row row-grid justify-content-between">
                <div class="col-lg-5">
                    ...
                    <tabs :fill="false" circle>
                        <tab-pane>
                            <span slot="title" class="nav-link-icon d-block"><i class="fa fa-cat"></i></span>
                        </tab-pane>
                        <tab-pane>
                            <span slot="title" class="nav-link-icon d-block"><i class="fa fa-crow"></i></span>
                        </tab-pane>
                        <tab-pane>
                            <span slot="title" class="nav-link-icon d-block"><i
                                    class="fa fa-dog"></i></span>
                        </tab-pane>
                    </tabs>
                </div>
                <div class="col-lg-5">
            ...
            <modals></modals>
             Datepicker
            <h3 class="h4 text-success font-weight-bold mt-5 mb-4">Datepicker</h3>
            <date-pickers></date-pickers>
            <!-- Tooltips and Popovers -->
            <h3 class="h4 text-success font-weight-bold mt-5 mb-4">Tooltips &amp; Popovers</h3>
            <tooltips></tooltips>
        </div>
    </section>
</template>
